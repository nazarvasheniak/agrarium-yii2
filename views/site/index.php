                ...
                <div class="cost_block">
                    <div class="items">
                        <div class="item item1">
                            ...
                            <div class="text">1 AGR НА PRE-ICO</div>
                        </div>
            ...
            <div class="graf">
                ...
                <div class="point_label label2">
                    <div class="label_wrap">
                        ...
                        <div class="label_value">1 AGR = 0.08$</div>
                        <div class="label_desc">Запуск площадки,<br> биржи продуктовых токенов</div>
                    </div>
                </div>
                ...
                <div class="point_label label3">
                    <div class="label_wrap">
                        ...
                        <div class="label_value">1 AGR = 0.08$</div>
                        <div class="label_desc">Масштабирование<br> по миру</div>
                    </div>
                </div>
